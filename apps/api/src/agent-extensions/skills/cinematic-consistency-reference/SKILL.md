...
Build an anchor prompt only from the static parts of the approved visual language: stable subject or product identity, environment, composition, lighting direction, specific style, material or line quality, and a few continuity-critical details. Do not add camera movement, frame rate, temporal action chains, dialogue, scene sound, or unsupported quality claims. Product anchors must preserve shape, materials, logo placement, and controlled reflections; animated anchors must preserve character design, line treatment, and palette.
